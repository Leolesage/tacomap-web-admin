...
<section class="tm-page-head mb-3">
    <div>
        <p class="tm-kicker m-0">Edition</p>
        <h1 class="m-0">Modifier TacosPlace</h1>
        <p class="tm-sub m-0">Mettez a jour les donnees et la position de ce lieu.</p>
    </div>
</section>
    ...
    <section class="tm-panel mb-3">
        ...
        <div class="row g-3">
            ...
            <div class="col-12">
                ...
                <div class="tm-photo-preview mb-2">
