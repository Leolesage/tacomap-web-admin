...
<section class="tm-page-head mb-3">
    <div>
        <p class="tm-kicker m-0">Creation</p>
        <h1 class="m-0">Nouveau TacosPlace</h1>
        <p class="tm-sub m-0">Renseignez les informations puis cliquez sur la carte pour definir la position.</p>
    </div>
</section>
...
<form method="post" action="/admin/tacos-places" enctype="multipart/form-data" novalidate>
    <?= View::csrfField() ?>

    <section class="tm-panel mb-3">
        <h2 class="tm-section-title">Informations</h2>
        <div class="row g-3">
            <div class="col-12">
    ...
    <section class="tm-panel mb-3">
        <h2 class="tm-section-title">Geolocalisation</h2>
        <div class="row g-3">
            <div class="col-md-6">
            ...
            <div class="col-12">
                ...
                <p class="form-text">Cliquez sur la carte pour definir latitude/longitude.</p>
            </div>
        </div>
    </section>

    <section class="tm-panel mb-3">
        <h2 class="tm-section-title">Contact et photo</h2>
        <div class="row g-3">
            <div class="col-md-6">
    ...
    <div class="mt-4 d-flex gap-2">
        ...
        <a href="/admin/tacos-places" class="btn btn-outline-secondary">Annuler</a>
    </div>
</form>
